...
local spam = {
  or: [
    ...
    { from: 'quero.comprar@madeiramadeira.com.br', from: 'rscsjo2@smartfit.com'}
  ],
};
...
local rules = [
  ...
  { filter: { or: [ { from: 'faturadigital@itau.com.br' }, { from: 'faturadigital@itaupersonnalite.com.br' }, { from: 'faturaporemail@santander.com.br' }, { from: 'faturas@cartoes.relacionamentosicredi.com' } ] }, actions: { archive: true, labels: ['Fatura do Cartão'] } },
];
